...
Scotland.''\cite[2]{curtis_org_1972}

\footnote{\red{this is a test footnote}}
\red{See \cite[4]{curtis_org_1972} for discussion of \emph{Light Infantry} and
...
pounds.''\cite[14-15]{curtis_org_1972}
...
delivered\ldots''\cite[16]{curtis_org_1972}
...
to three rounds per minute.\cite[17]{curtis_org_1972} ``With bayonets fixed,
only one rounds could be fired to much purpose; since the bayonet made it
difficult to ram down the charge.''\cite[17]{curtis_org_1972}

\red{infantry highly dependant on weather: rain/wind can prevent
firing\cite[19]{curtis_org_1972}}
...
six.\cite[21]{curtis_org_1972}

\red{dicussion of the purchase system for commissions.\cite[24-29]{curtis_org_1972}}

``By 1781 a force of 110,000 man had been enrolled, of which about 56,000 were
located in America and the West Indes.''\cite[51]{curtis_org_1972} Recruiting
